<?php
// $Id: page-job-application_.tpl.php,v 1.4 2009/07/21 02:55:40 rommelm Exp $
...
<!-- Navmain start --> 
        <div id="navMain">
          <?php if (isset($primary_links)) { ?><?php print theme_nice_menus_primary_links('down', '1'); 
		  		//print theme('accretivesolutions_control_links', $primary_links, array('class' => 'links', 'id' => 'navlist')) ?><?php } ?>
        </div>  
<!-- Navmain end -->
<!-- Shadows start -->
<div id="shadowSides">
                    ...
                    <div id="colBlockLeftWide">
                        <div id="col1Wide">
                            <div class="content padding">
                              ...
                              <?php print $help; ?>
                              <?php //print $content; ?>
                              <?php print node_view(node_load($node->nid, FALSE, TRUE, FALSE)); ?>
