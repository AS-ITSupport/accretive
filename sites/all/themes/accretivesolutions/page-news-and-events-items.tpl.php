<?php
// $Id: page-news-and-events-items.tpl.php,v 1.1 2009/08/25 07:25:20 jessem Exp $
                    ...
                    <div id="colBlockLeftWide2">                    
                      ...
                      <div id="col2">
                        <div class="content padding">
                          ...
                          <?php print $help; ?>                                                                              
                          <?php 
if (stristr($content, '<a href="mailto:cpeevents-jacksonville@accretivesolutions.com">cpeevents-jacksonville@accretivesolutions.com</a>')) {
$content = str_replace('Event Contact Email:', '', $content);

$content = str_replace('<a href="mailto:cpeevents-jacksonville@accretivesolutions.com">cpeevents-jacksonville@accretivesolutions.com</a>', '', $content);
...
else if (stristr($content, '<a href="mailto:dallasseminars@accretivesolutions.com">dallasseminars@accretivesolutions.com</a>')) {
$content = str_replace('Event Contact Email:', '', $content);

$content = str_replace('<a href="mailto:dallasseminars@accretivesolutions.com">dallasseminars@accretivesolutions.com</a>', '', $content);
