<?php
// $Id: page-consulting-services-industries-clients.tpl.php,v 1.7 2009/07/21 02:55:40 rommelm Exp $
                    ...
                    <div id="colBlockLeftWide2">
                      ...
                      <div id="col2">
                        <div class="content padding">
                          ...
                          <?php
                                                            $terms = accretivesolutions_get_terms_voc_name('Industries');
                                                            foreach($terms as $term) {
                                                                ...
                                                                if(!empty($view->result)) {
                                                                    ...
                                                                    $view2 = views_get_view('clients');
                                                                    print $view2->execute_display('defaults', array($term->tid));                                                                                                                                
                                                                }
