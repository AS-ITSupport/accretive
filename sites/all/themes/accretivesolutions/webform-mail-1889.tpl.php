...
// $Id: webform-mail-1889.tpl.php,v 1.4 2009/09/30 05:27:13 jessem Exp $



/**

 * Event Registration webform email template
...
<p>
  ...
  <?php 
    ...
    print t('Submitted on @date', array('@date' => format_date(time(), 'small'))) 
...
<p>
  ...
  <?php 
    ...
    print t('Submitted by user: @username [@ip_address]', 

              array('@username' => $user->name, '@ip_address' => $ip_address)
...
<p>
  ...
  <?php 
    ...
    print t('Submitted by anonymous user: [@ip_address]', 
